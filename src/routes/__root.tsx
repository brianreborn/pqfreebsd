  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Post-quantum access control for FreeBSD: Integrity Evidence ledger and dynamically repaired DAC, derived from freebsd-mac-grok and pqac(7).",
      },
