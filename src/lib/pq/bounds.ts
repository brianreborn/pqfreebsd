...
export function evaluateBounds(world: World): Measure[] {
  ...
  return [
    ...
    },
    {
      ...
      claim: "T2 / lattice",
      kind: "lattice",
      measure: "Low-integrity cannot overwrite high-integrity files",
      proves: "Short proof: a low-integrity process cannot overwrite a high-integrity OS file once it has read low-integrity data.",
